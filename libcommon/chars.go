...
func IsAsciiWhitespace(c rune) bool {
	whitespace_codes := []rune{0x0009, 0x000a, 0x000c, 0x000d}
	return slices.Contains(whitespace_codes, c)
}
...
func IsNoncharacter(c rune) bool {
	...
	return slices.Contains(noncharacter_codes, c)
}
